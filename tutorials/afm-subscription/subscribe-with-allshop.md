...
# HOW TO SUBSCRIBE TO ALBION FREE MARKET VIA EZARENA
...
- **Create (or sign in to) your EZARENA profile**: Account creation is free and required to purchase.
...
3. **Review payment options**
   - EZARENA supports multiple processors; select the one that works in your region.
...
4. **Submit the order**
   ...
   - Finish the payment flow and wait for the EZARENA confirmation screen.
...
- All subscriptions remain non-refundable, even when purchased through EZARENA, as stated on the support page.
